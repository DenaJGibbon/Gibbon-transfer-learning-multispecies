...
trained_models_dir <- '/Users/denaclink/Desktop/RStudioProjects/Gibbon-transfer-learning-multispecies/model_output/_imagescambodia_binary_unfrozen_TRUE_/'
...
evaluate_trainedmodel_performance(trained_models_dir=trained_models_dir,
                                  ...
                                  output_dir = "/Volumes/DJC Files/MultiSpeciesTransferLearning/WideArrayEvaluation/Jahoo/model_eval_allmodels/",
                                  positive.class='CrestedGibbons')


PerformanceOutPutTrained <- gibbonNetR::get_best_performance(performancetables.dir= "/Volumes/DJC Files/MultiSpeciesTransferLearning/WideArrayEvaluation/Jahoo/model_eval_allmodels/performance_tables_trained/",
...
trained_models_dir <- '/Users/denaclink/Desktop/RStudioProjects/Gibbon-transfer-learning-multispecies/model_output/_imagesmalaysia_binary_unfrozen_TRUE_/'

image_data_dir <- '/Volumes/DJC Files/MultiSpeciesTransferLearning/WideArrayEvaluation/DanumValley/Images/'

evaluate_trainedmodel_performance(trained_models_dir=trained_models_dir,
                                  image_data_dir=image_data_dir,
                                  output_dir = "/Volumes/DJC Files/MultiSpeciesTransferLearning/WideArrayEvaluation/DanumValley/model_eval_allmodels/",
                                  positive.class='GreyGibbons')


PerformanceOutPutTrained <- gibbonNetR::get_best_performance(performancetables.dir='/Volumes/DJC Files/MultiSpeciesTransferLearning/WideArrayEvaluation/DanumValley/model_eval_allmodels/performance_tables_trained/',
...
evaluate_trainedmodel_performance_multi(trained_models_dir=trained_models_dir,
                                        ...
                                        image_data_dir=image_data_dir,
                                        output_dir="/Volumes/DJC Files/MultiSpeciesTransferLearning/WideArrayEvaluation/Jahoo/model_eval_allmodels_multi/",
                                        noise.category = "Noise")



PerformanceOutPutTrained <- gibbonNetR::get_best_performance(performancetables.dir='/Volumes/DJC Files/MultiSpeciesTransferLearning/WideArrayEvaluation/Jahoo/model_eval_allmodels_multi/performance_tables_multi_trained',
                                                             model.type = 'multi',
...
evaluate_trainedmodel_performance_multi(trained_models_dir=trained_models_dir,
                                        ...
                                        #trainingfolder=trainingfolder,
                                        image_data_dir=image_data_dir,
                                        output_dir="/Volumes/DJC Files/MultiSpeciesTransferLearning/WideArrayEvaluation/DanumValley/model_eval_allmodels_multi/",
                                        noise.category = "Noise")



PerformanceOutPutTrained <- gibbonNetR::get_best_performance(performancetables.dir='/Volumes/DJC Files/MultiSpeciesTransferLearning/WideArrayEvaluation/DanumValley/model_eval_allmodels_multi/performance_tables_multi_trained',
                                                             model.type = 'multi',
...
performancetables.dir.multi.crested <- '/Volumes/DJC Files/MultiSpeciesTransferLearning/WideArrayEvaluation/Jahoo/model_eval_allmodels_multi/performance_tables_multi_trained/'
...
performancetables.dir.multi.grey <- '/Volumes/DJC Files/MultiSpeciesTransferLearning/WideArrayEvaluation/DanumValley/model_eval_allmodels_multi/performance_tables_multi_trained/'
