...
CrestedTopBinary <- read.csv('/Volumes/DJC Files/MultiSpeciesTransferLearning/WideArrayEvaluation/Jahoo/model_eval_allmodels/performance_tables_trained/imagescambodia_5_resnet152_model_TransferLearningTrainedModel.csv')
...
GreyTopBinary <- read.csv('/Volumes/DJC Files/MultiSpeciesTransferLearning/WideArrayEvaluation/DanumValley/model_eval/performance_tables_trained/imagesmalaysia_2_resnet152_model_TransferLearningTrainedModel.csv')
...
BestF1data.frameCrestedGibbonMulti <- subset(BestF1data.frameCrestedGibbonMulti,Class=='CrestedGibbons')
